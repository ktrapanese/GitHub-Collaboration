...
if answer == "No" or answer == "no" or answer == "NO" or answer == "N" or answer == "n":
    ...
    print('Well...see ya later, ' + actual_name + '. Oh, and please invite your friends to take on the impossible challenge that is "The Impossible Game"! See ya! ;)')
    ...
    print("I bid you adieu, " + actual_name + ". And don't forget you can always invite others to this code too. Thank you for your time!")
    #Random comment